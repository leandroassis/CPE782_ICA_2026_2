"""Teste de integracao: fit() + evaluate() ponta a ponta com as 3 metricas reais."""
...
def test_evaluate_with_real_metrics_returns_sane_values(
    ...
    """As 3 metricas devem retornar valores plausiveis apos um fit() real."""
    ...
    results = model.evaluate([ConvergenceIterations(), ExecutionTime(), NonGaussianityScore()])
