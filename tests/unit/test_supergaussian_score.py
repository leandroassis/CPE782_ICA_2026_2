"""Testes unitarios para SuperGaussianScore (skill ica-ml, Secoes 3-4)."""
...
def test_score_matches_closed_form():
    """score(y) deve ser exatamente -2*tanh(y) (livro, sem sinal na frente de g)."""
...
def test_derivative_is_negative_everywhere():
